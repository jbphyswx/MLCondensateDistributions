...
It writes parquet files into the package-wide processed-data directory by default.
"""
...
Generate AMIP baseline training data into parquet files.
...
function generate_data!(;
    ...
    min_dh::Float32 = DEFAULT_MIN_H_RESOLUTION,
...
if abspath(PROGRAM_FILE) == @__FILE__
    ...
    min_dh = parse(Float32, get(ENV, "MIN_H_RESOLUTION", string(DEFAULT_MIN_H_RESOLUTION)))
