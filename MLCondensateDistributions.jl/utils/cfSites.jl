...
const cfSitesDefaults = (;
    min_horizontal_averaging_domain = Float32(200), # need to check if this is correct
    max_vertical_averaging_domain = Float32(400), # need to check if this is correct
)
